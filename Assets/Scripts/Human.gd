...
## How quickly the attacking animation is in full motion with 1.0 beïng instant and 0.0 doing nothing.
@export_range(0.01, 1.0) var attacking_lerp = 0.25
## How quickly the blocking animation is in full motion with 1.0 beïng instant and 0.0 doing nothing.
@export_range(0.01, 1.0) var blocking_lerp = 0.25
...
func capture_input():
	super.capture_input()
	input_is_attacking = input_controller.is_attacking()
	input_is_blocking = input_controller.is_blocking()
